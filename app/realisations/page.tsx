            ...
            {videos.map((video, index) => {
              ...
              return (
                ...
                >
                    ...
                    <div className={`absolute inset-0 transition-all duration-300 ${isActive
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${isActive
                          ...
                          <Play className={`w-8 h-8 ml-1 ${isActive ? 'text-black' : 'text-[#2A2A2A] group-hover:text-black'
                            }`} fill="currentColor" />
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Title */}
                  <div className={`p-4 transition-colors duration-300 ${isActive
                    ? 'bg-[#FFD700] text-black'
                    : 'bg-[#1A1A1A] text-white group-hover:bg-[#FFD700] group-hover:text-black'
                    }`}>
                    <p className={`font-semibold text-sm line-clamp-2 ${isActive ? 'text-black' : 'group-hover:text-black'
                      }`}>
                      {video.title}
                    </p>
                  </div>
